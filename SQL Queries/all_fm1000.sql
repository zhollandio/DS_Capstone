...
FOR yr IN (SELECT year FROM UNNEST(GENERATE_ARRAY(2003, 2016)) AS year) DO
  EXECUTE IMMEDIATE FORMAT("""
      ...
      ADD COLUMN IF NOT EXISTS fm1000_value FLOAT64
  """, yr.year);
  ...
  EXECUTE IMMEDIATE FORMAT("""
      ...
      WHEN MATCHED THEN
        UPDATE SET fm1000_value = closest_weather.fm1000_value
